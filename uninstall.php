...
if (!$opwc_remove_data) {
    $opwc_remove_data = get_option('czpwc_remove_data_on_uninstall', false);
}

if ((defined('OPWC_REMOVE_ALL_DATA') && OPWC_REMOVE_ALL_DATA) || (defined('CZPWC_REMOVE_ALL_DATA') && CZPWC_REMOVE_ALL_DATA)) {
